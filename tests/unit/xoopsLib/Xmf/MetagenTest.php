...
class MetagenTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var Metagen
     */
...
EOT;
    ...
    public function testGenerateDescription()
    {
        ...
        $numWords = 20;
        $desc = $this->object->generateDescription($body, $numWords);
        $actual = mb_substr($desc, -1, null, 'UTF-8');
    ...
    /**
     * @covers Xmf\Metagen::getSearchSummary
     */
...
EOT;
    ...
    /**
     * @covers Xmf\Metagen::asPlainText
     */
