...
class SelectTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testRender()
    {
        ...
        $this->assertTrue(false !== mb_strpos($value, 'value="opt_key"'));
        $this->assertTrue(false !== mb_strpos($value, '>opt_name</option>'));
        $this->assertTrue(false !== mb_strpos($value, 'value="opt_just_key"'));
        $this->assertTrue(false !== mb_strpos($value, '>opt_just_key</option>'));
        ...
        $this->assertTrue(false !== mb_strpos($value, 'title="Caption"'));
        $this->assertTrue(false !== mb_strpos($value, 'id="name"'));
        $this->assertTrue(false !== mb_strpos($value, '<optgroup'));
        $this->assertTrue(false !== mb_strpos($value, 'label="opt_grp_name"'));
        $this->assertTrue(false !== mb_strpos($value, '<option'));
        $this->assertTrue(false !== mb_strpos($value, 'value="grp_key"'));
        $this->assertTrue(false !== mb_strpos($value, '>grp_name</option>'));
        $this->assertTrue(false !== mb_strpos($value, 'value="grp_key1"'));
        $this->assertTrue(false !== mb_strpos($value, '>grp_name1</option>'));
    }
    ...
    public function testRenderValidationJS()
    {
        ...
        $value = $this->object->renderValidationJS();
        $this->assertInternalType('string', $value);
        $this->assertTrue(false !== mb_strpos($value, 'window.alert'));
    }
