...
class ShortCodesTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @todo   Implement testAddShortcode().
     */
     ...
     * @todo   Implement testRemoveShortcode().
     */
     ...
     * @todo   Implement testGetShortcodes().
     */
     ...
     * @todo   Implement testHasShortcode().
     */
     ...
     * @todo   Implement testContentHasShortcode().
     */
     ...
     * @todo   Implement testStripAllShortcodes().
     */
