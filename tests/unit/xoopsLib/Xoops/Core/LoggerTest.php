...
class LoggerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function test_handleError100()
    {
        ...
        $this->assertTrue(false !== mb_strpos($result, 'notice:'));
        $this->assertTrue(false !== mb_strpos($result, 'errstr'));
        $this->assertTrue(false !== mb_strpos($result, 'errfile'));
        $this->assertTrue(false !== mb_strpos($result, 'errline'));
    }
    ...
    public function test_handleError140()
    {
        ...
        $this->assertTrue(false !== mb_strpos($result, 'warning:'));
        $this->assertTrue(false !== mb_strpos($result, 'errstr'));
        $this->assertTrue(false !== mb_strpos($result, 'errfile'));
        $this->assertTrue(false !== mb_strpos($result, 'errline'));
    }
    ...
    public function test_handleError200()
    {
        ...
        $this->assertTrue(false !== mb_strpos($result, 'error:'));
        $this->assertTrue(false !== mb_strpos($result, 'errstr'));
        $this->assertTrue(false !== mb_strpos($result, 'errfile'));
        $this->assertTrue(false !== mb_strpos($result, 'errline'));
    }
