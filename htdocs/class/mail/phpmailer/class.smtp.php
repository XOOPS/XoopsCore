...
class SMTP
{
     ...
     *
     * @param string $host mailhost
     * @param int    $port port on the host
     * @param int    $tval timeout value
     *
     * @return bool
     */
     ...
     * @param string $password password to host
     *
     * @return bool
     */
     ...
     *
     * @param string $msg_data sends message to server
     *
     * @return bool
     */
     ...
     * SMTP CODE ERROR  : 500
     *
     * @param bool $close_on_error close the file on error
     *
     * @return bool
     */
     ...
     * SMTP CODE ERROR  : 500,501,503,421
     *
     * @param string $to address to send it to
     *
     * @return bool
     */
