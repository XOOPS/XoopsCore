 ...
 * PHP 5.3
 *
 * @category  Xoops\Class\Phpmailer\Phpmailer
 * @package   Phpmailer
 * @author    Andy Prevost
...
class PHPMailer
{
     ...
     *
     * @param string $address address to reply to
     * @param string $name    name related to address
     *
     * @return boolean
     */
     ...
     * @param int    $auto    if sent automatically then 1 or true
     *
     * @return boolean
     */
    ...
    public static function ValidateAddress($address)
    {
        if (function_exists('filter_var')) { //Introduced in PHP 5.2
            ...
            return preg_match(
                ...
                .'(?:[a-zA-Z0-9_\-](?!$)){0,61}[a-zA-Z0-9_]?)|(?:\[(?:(?:[01]?\d{1,2}|2[0-4]'
                .'\d|25[0-5])\.){3}(?:[01]?\d{1,2}|2[0-4]\d|25[0-5])\]))$/',
                $address
            );
        }
    }
    ...
    public function SetLanguage($langcode = 'en', $lang_path = 'language/')
    {
        ...
        //Overwrite language-specific strings. This way we'll never have missing translations
        $l = true;
     ...
     *
     * @param string $type type of header to create
     * @param string $addr address to add to header
     *
     * @return string
     */
    ...
    public function CreateBody()
    {
        ...
        switch ($this->message_type) {
            ...
            case 'alt_attachments':
                ...
                $body .= $this->LE; // Create the HTML body
                $body .= $this->EncodeString($this->Body, $this->Encoding);
                $body .= $this->LE . $this->LE;
     ...
     * @param string $charSet     charset using
     ...
     *
     * @param string $boundary boundary to check
     *
     * @return string
     */
     ...
     * @param string $value value to add to name
     *
     * @return string
     */
     ...
     * @param string $position find test in header
     *
     * @return string
     */
     ...
     * @param bool   $space_conv convert spaces?
     *
     * @return string
     */
     ...
     *
     * @param string $key language key to use
     *
     * @return string
     */
     ...
     *
     * @param string $custom_header header to add
     *
     * @return void
     */
     ...
     * @param string $basedir base directory of stuff to include
     *
     * @return string
     */
     ...
     *
     * @param string $cert_filename file name of certificate
     ...
     * call back
     *
     * @param string $isSent  is it sent
     * @param string $to      who sent to
     * @param string $cc      carbon copy address
     * @param string $bcc     blank carbon copy address
