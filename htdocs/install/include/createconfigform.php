...
function createThemeform(XoopsConfigItem $config)
{
    ...
    foreach ($dirlist as $theme) {
        ...
        if (file_exists(\XoopsBaseConfig::get('root-path') . "/themes/$theme/theme.ini")) {
            $theme_ini = parse_ini_file(\XoopsBaseConfig::get('root-path') . "/themes/$theme/theme.ini");
        ...
        if ($theme_ini['screenshot'] != '' && file_exists(\XoopsBaseConfig::get('root-path') . "/themes/$theme/" . $theme_ini['screenshot'])) {
            $label_content .= "<img src='" . \XoopsBaseConfig::get('url') . "/themes/" . $theme . "/" . $theme_ini['screenshot'] . "' alt='Screenshot' />";
        } elseif ($theme_ini['thumbnail'] != '' && file_exists(\XoopsBaseConfig::get('root-path') . "/themes/$theme/" . $theme_ini['thumbnail'])) {
            $label_content .= "<img src='" . \XoopsBaseConfig::get('url') . "/themes/" . $theme . "/" . $theme_ini['thumbnail'] . "' alt='$theme' />";
        } else {
