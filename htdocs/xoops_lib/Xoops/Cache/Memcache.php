...
/**
 * Memcache storage engine for Xoops_Cache
 * PHP 5
...
/**
 * Memcache storage engine for Xoops_Cache.  Memcache has some limitations in the amount of
 * control you have over expire times far in the future.  See MemcacheEngine::write() for
 * more information.
 *
 * @package       Cake.Cache.Engine
 */
class Xoops_Cache_Memcache extends Xoops_Cache_Abstract
{
    /**
    ...
    public function init($settings = array())
    {
        ...
        $settings += array(
            'engine' => 'Memcache', 'servers' => array('127.0.0.1'), 'compress' => false, 'persistent' => true
        );
    ...
    {
        if ($this->settings['compress']) {
            trigger_error(sprintf('Method increment() not implemented for compressed cache in %s', __CLASS__));
        }
    ...
    {
        if ($this->settings['compress']) {
            trigger_error(sprintf('Method decrement() not implemented for compressed cache in %s', __CLASS__));
        }
