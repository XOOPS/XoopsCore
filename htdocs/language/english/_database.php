...
define("_DB_TABLE_ALTERED", "Table %s updated."); // L133
define("_DB_TABLE_NOT_ALTERED", "Failed updating table %s."); // L134
define("_DB_TABLE_DROPPED", "Table %s dropped."); // L163
define("_DB_TABLE_NOT_DROPPED", "Failed deleting table %s."); // L164
*/