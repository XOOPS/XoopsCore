...
if (substr(\XoopsBaseConfig::get('version'), 0, 9) < "XOOPS 2.3") {
...
if (!defined("FRAMEWORKS_ART_FUNCTIONS_INI")):
    ...
    // define("FRAMEWORKS_ROOT_PATH", \XoopsBaseConfig::get('root-path') . "/Frameworks"); See XoopsConfigBase
    ...
    function load_objectHandler($handler = "", $dirname = "art")
    {
        ...
        class_exists($handlerClass) || require_once \XoopsBaseConfig::get('frameworks-path') . "/{$dirname}/{$fileName}";
