...
$icons = XoopsLists::getDirListAsArray(XOOPS_ROOT_PATH . '/modules/system/assets/images/icons');
$modversion['config'][] = array(
    'name' => 'typeicons',
    'title' => 'CONF_ICONS',
    'description' => '',
...
$breadcrumb = XoopsLists::getDirListAsArray(XOOPS_ROOT_PATH . '/modules/system/assets/images/breadcrumb');
$modversion['config'][] = array(
    'name' => 'typebreadcrumb',
