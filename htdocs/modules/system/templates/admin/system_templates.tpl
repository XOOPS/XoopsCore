...
<div class="spacer">
    <table class="outer ui-corner-all" cellspacing="1">
		...
		<tr>
			...
			<td class="aligntop">
				<div id="display_form">
                <{includeq file="module:system|system_form.tpl"}>
                </div>
				<div id="display_contenu"></div>
				<div id='display_message' class="txtcenter" style="display:none;"></div>
				<div id='loading' class="txtcenter" style="display:none;"><br /><br /><img src="assets/images/loading.gif" title="Loading" alt="Loading" /></div>
			</td>
		</tr>
    </table>
