...
<div class="xo-module-installed outer">
    <div class="xo-window xo-module-list">
        ...
        <div class="xo-window-data">
            <div class="xo-content-card <{$view_large}>"><{includeq file="admin:system|system_modules_card.tpl"}></div>
            <div class="xo-content-table <{$view_line}>"><{includeq file="admin:system|system_modules_table.tpl"}></div>
        </div>
    </div>
    <div class="clear"></div>
</div>
<div class="xo-module-install outer">
    <div class="xo-window xo-module-list">
        ...
        <div class="xo-window-data">
            <{includeq file="admin:system|system_modules_available.tpl"}>
        </div>
    </div>
    <div class="clear"></div>
</div>
...
<div id="install" class="modal hide">
    ...
    <div class="modal-footer">
        <form id="install-form" method="post" action="admin.php">
            ...
            <{php}>echo Xoops::getInstance()->security()->getTokenHTML();<{/php}>
