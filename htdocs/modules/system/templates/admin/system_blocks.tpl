						...
						<table id="xo-block-footer">
							<tr>
								<td side="11" class="xo-blocksection">
									<div class="xo-title"><{translate key='FOOTER_LEFT' dirname='system'}></div>
									<{include file="admin:system/system_blocks_item.tpl" blocks=$blocks side=11}>
								</td>
								<td side="13" class="xo-blocksection">
									<div class="xo-title"><{translate key='FOOTER_CENTER' dirname='system'}></div>
									<{include file="admin:system/system_blocks_item.tpl" blocks=$blocks side=13}>
								</td>
								<td side="12" class="xo-blocksection">
									<div class="xo-title"><{translate key='FOOTER_RIGHT' dirname='system'}></div>
									<{include file="admin:system/system_blocks_item.tpl" blocks=$blocks side=12}>
								</td>
							</tr>
						</table>
                    </tr>
