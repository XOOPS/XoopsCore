    ...
    <form name='memberslist' id='memberslist' action='<{$php_selft}>' method='POST'>
        <table id="xo-users-sorter" class="outer tablesorter">
            ...
            <tr class="<{cycle values='even,odd'}> alignmiddle">
                ...
                <td class="txtcenter"><div id="display_post_<{$users.uid}>"><{$users.posts}></div><div id='loading_<{$users.uid}>' class="txtcenter" style="display:none;"><img src="./assets/images/mimetypes/spinner.gif" title="Loading" alt="Loading"/></div></td>
