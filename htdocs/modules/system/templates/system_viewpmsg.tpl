...
<br />
<ul class="breadcrumb">
    <li><a href="userinfo.php?uid=<{$uid}>"><{translate key='PROFILE'}></a> <span class="divider">/</span></li>
    ...
    <table class="table table-striped table-bordered table-condensed">
        <tr>
            ...
            <th class='width5' style="text-align: center;">
                <img class='bnone' src='<{xoAppUrl assets/images/download.gif}>' alt=''/>
            </th>
            <th class='width5'>&nbsp;</th>
            <th class='width10'>
                <{translate key='FROM'}>
        ...
        <tr>
            ...
            <td class='width5' style="text-align: center;">
                <{if $message.msg_image != ""}>
                    <img src='<{$xoops_url}>/assets/images/subject/<{$message.msg_image}>' alt='' />
                <{/if}>
            </td>
            <td class='width10'>
