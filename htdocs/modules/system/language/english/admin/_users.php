...
//define("_AM_SYSTEM_USERS_NAV_LIST","List");
...
//define("_AM_SYSTEM_USERS_PTBBTSDIYT","Push the button below to synchronize data if you think the above user posts info is not the actual status");
