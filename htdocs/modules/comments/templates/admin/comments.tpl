...
<form name='commentslist' id='commentslist' action='<{$php_selft}>' method="post">
    <table id="xo-comment-sorter" class="outer tablesorter">
        ...
        <tr class="<{cycle values='even,odd'}> alignmiddle">
            ...
            <td class="txtcenter"><{$comments.comments_title}></td>
            ...
            <td class="xo-actions txtcenter">
                <img class="cursorpointer" onclick="display_dialog('<{$comments.comments_id}>', true, true, 'slide', 'slide', 300, 500);" src="<{xoAdminIcons display.png}>" alt="<{$smarty.const._AM_COMMENTS_VIEW}>" title="<{$smarty.const._AM_COMMENTS_VIEW}>" />
                <a href="comment_edit.php?com_id=<{$comments.comments_id}>" title="<{translate key='A_EDIT'}>">
                    <img src="<{xoAdminIcons edit.png}>" alt="<{translate key='A_EDIT'}>">
                </a>
                <a href="comment_delete.php?com_id=<{$comments.comments_id}>" title="<{translate key='A_DELETE'}>">
