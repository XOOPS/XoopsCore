...
switch ($op) {
    ...
    default:
        ...
        foreach ($files as $filename_path) {
            $filename = basename(mb_strtolower($filename_path));
    ...
    case 'dump_save':
        ...
        if ((true == $dump_tables && true == $dump_modules) || (false == $dump_tables && false == $dump_modules)) {
