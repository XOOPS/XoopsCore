...
//define('_MD_DEBUGBAR_UNKNOWN', "Unknown");
//define('_MD_DEBUGBAR_E_USER_NOTICE', "Notice");
//define('_MD_DEBUGBAR_E_USER_WARNING', "Warning");
//define('_MD_DEBUGBAR_E_USER_ERROR', "Error");
//define('_MD_DEBUGBAR_E_NOTICE', "Notice");
//define('_MD_DEBUGBAR_E_WARNING', "Warning");
//define('_MD_DEBUGBAR_E_STRICT', "Strict");
//define('_MD_DEBUGBAR_FILELINE', "%s in file %s line %s");
