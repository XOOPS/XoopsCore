...
class ProfileFieldForm extends XoopsThemeForm
{
    /**
    ...
    public function __construct(ProfileField $obj)
    {
        ...
        $this->addElement(new XoopsFormText(_PROFILE_AM_TITLE, 'field_title', 5, 255, $obj->getVar('field_title', 'e')), true);
        $this->addElement(new XoopsFormTextArea(_PROFILE_AM_DESCRIPTION, 'field_description', $obj->getVar('field_description', 'e'), 5, 5));
        ...
        $weight = new XoopsFormText(_PROFILE_AM_WEIGHT, 'field_weight', 1, 10, $obj->getVar('field_weight', 'e'), '');
        $weight->setPattern('^\d+$', _PROFILE_AM_ERROR_WEIGHT);
        $this->addElement($weight, true);
        if ($obj->getVar('field_config') || $obj->isNew()) {
            if (!$obj->isNew()) {
                $this->addElement(new XoopsFormLabel(_PROFILE_AM_NAME, $obj->getVar('field_name')));
                $this->addElement(new XoopsFormHidden('id', $obj->getVar('field_id')));
            } else {
                $this->addElement(new XoopsFormText(_PROFILE_AM_NAME, 'field_name', 5, 255, $obj->getVar('field_name', 'e')), true);
            }
            ...
            $element_select = new XoopsFormSelect(_PROFILE_AM_TYPE, 'field_type', $obj->getVar('field_type', 'e'));
            ...
            switch ($obj->getVar('field_type')) {
                case "textbox":
                    ...
                    $type_select = new XoopsFormSelect(_PROFILE_AM_VALUETYPE, 'field_valuetype', $obj->getVar('field_valuetype', 'e'), 5, 5);
                ...
                case "radio":
                    ...
                    $type_select = new XoopsFormSelect(_PROFILE_AM_VALUETYPE, 'field_valuetype', $obj->getVar('field_valuetype', 'e'));
                    $type_select->addOptionArray($valuetypes);
                    $this->addElement($type_select);
                    break;
            }

            //$this->addElement(new XoopsFormRadioYN(_PROFILE_AM_NOTNULL, 'field_notnull', $obj->getVar('field_notnull', 'e') ));
            ...
            if ($obj->getVar('field_type') == "select" || $obj->getVar('field_type') == "select_multi" || $obj->getVar('field_type') == "radio" || $obj->getVar('field_type') == "checkbox") {
                ...
                $option_text .= "</table>";
                $this->addElement(new XoopsFormLabel(_PROFILE_AM_ADDOPTION, $option_text));
            }
        }
        ...
        if ($obj->getVar('field_edit')) {
            switch ($obj->getVar('field_type')) {
                ...
                case "textarea":
                case "dhtml":
                    $this->addElement(new XoopsFormText(_PROFILE_AM_MAXLENGTH, 'field_maxlength', 5, 5, $obj->getVar('field_maxlength', 'e')));
                    $this->addElement(new XoopsFormTextArea(_PROFILE_AM_DEFAULT, 'field_default', $obj->getVar('field_default', 'e')));
                    break;
                ...
                case "date":
                    $this->addElement(new XoopsFormTextDateSelect(_PROFILE_AM_DEFAULT, 'field_default', 2, $obj->getVar('field_default', 'e')));
                    break;

                case "longdate":
                    $this->addElement(new XoopsFormTextDateSelect(_PROFILE_AM_DEFAULT, 'field_default', 2, strtotime($obj->getVar('field_default', 'e'))));
                    break;

                case "datetime":
                    $this->addElement(new XoopsFormDateTime(_PROFILE_AM_DEFAULT, 'field_default', 2, $obj->getVar('field_default', 'e')));
                    break;

                case "yesno":
                    $this->addElement(new XoopsFormRadioYN(_PROFILE_AM_DEFAULT, 'field_default', $obj->getVar('field_default', 'e')));
                    break;

                case "timezone":
                    $this->addElement(new XoopsFormSelectTimezone(_PROFILE_AM_DEFAULT, 'field_default', $obj->getVar('field_default', 'e')));
                    break;

                case "language":
                    $this->addElement(new XoopsFormSelectLang(_PROFILE_AM_DEFAULT, 'field_default', $obj->getVar('field_default', 'e')));
                    break;

                case "group":
                    $this->addElement(new XoopsFormSelectGroup(_PROFILE_AM_DEFAULT, 'field_default', true, $obj->getVar('field_default', 'e')));
                    break;

                case "group_multi":
                    $this->addElement(new XoopsFormSelectGroup(_PROFILE_AM_DEFAULT, 'field_default', true, unserialize($obj->getVar('field_default', 'n')), 5, true));
                    break;

                case "theme":
                    $this->addElement(new XoopsFormSelectTheme(_PROFILE_AM_DEFAULT, 'field_default', $obj->getVar('field_default', 'e')));
                    break;
        ...
        if (in_array($obj->getVar('field_type'), $searchable_types)) {
            ...
            $this->addElement(new XoopsFormSelectGroup(_PROFILE_AM_PROF_SEARCH, 'profile_search', true, $search_groups, 5, true));
        }
        if ($obj->getVar('field_edit') || $obj->isNew()) {
            ...
            $this->addElement(new XoopsFormSelectGroup(_PROFILE_AM_PROF_EDITABLE, 'profile_edit', false, $editable_groups, 5, true));
            $this->addElement(new XoopsFormRadioYN(_PROFILE_AM_REQUIRED, 'field_required', $obj->getVar('field_required', 'e')));
            $regstep_select = new XoopsFormSelect(_PROFILE_AM_PROF_REGISTER, 'step_id', $obj->getVar('step_id', 'e'));
