...
define("_MI_PUBLISHER_ADMENU6", "Mimetypes");

define("_MI_PUBLISHER_ADMINHITS", "Admin counter reads?");
define("_MI_PUBLISHER_ADMINHITSDSC", "Allow admin hits for counter stats?");
...
define("_MI_PUBLISHER_MD_DESC", "Section Management System for your XOOPS Site");
...
define("_MI_PUBLISHER_PV_TEXTDSC", "Message for articles that allows only partial view.");
...
define("_MI_PUBLISHER_ARTCOUNTDSC", "Select 'Yes' to display the article count within each category in the category summary table. Please note that the module currently only counts articles within each category and does not count within subcategoies.");
...
define("_MI_PUBLISHER_FORM_DOBR", "'Enable linebreak' set to TRUE");
...
define("_MI_PUBLISHER_CONFCAT_SEO_DSC", "Preferences for rewriting methods, metadata, etc");
