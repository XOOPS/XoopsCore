...
if (!$helper->getConfig('perm_search')
    || !$gpermHandler->checkRight('global', _PUBLISHER_SEARCH, $groups, $module_id)) {
...
XoopsLoad::loadFile($helper->path($module_info_search['file']));
...
$xoopsTpl->assign('modulename', $helper->getModule()->getVar('name'));

if ($xoopsConfigSearch['keyword_min'] > 0) {
    $xoopsTpl->assign('search_rule', sprintf(XoopsLocale::F_KEYWORDS_SHORTER_THAN_WILL_BE_IGNORED, $xoopsConfigSearch['keyword_min']));
}
