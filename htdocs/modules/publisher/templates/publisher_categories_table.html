...
<table border="0" width="90%" cellspacing="1" cellpadding="0" align="center" class="outer">
    ...
    <tr>
        <td class="even" align="left">
            ...
            <a href="<{$publisher_url}>/admin/category.php?op=mod&categoryid=<{$category.categoryid}>"><img src="<{$publisher_url}>/images/links/cat.gif" title="<{$lang_editcategory}>" alt="<{$lang_editcategory}>"/></a>&nbsp; <{else}>
    ...
    <tr>
        <td class="odd" align="left">
            <div style="padding-left: 10px;">
                ...
                <a href="<{$publisher_url}>/admin/category.php?op=mod&categoryid=<{$subcat.categoryid}>"><img src="<{$publisher_url}>/images/links/subcat.gif" title="<{$lang_editcategory}>" alt="<{$lang_editcategory}>" alt="<{$lang_editcategory}>"/></a>&nbsp;<{$subcat.categorylink}> <{else}>
                <img src="<{$publisher_url}>/images/links/subcat.gif" title="<{$lang_editcategory}>" alt="<{$lang_editcategory}>"/>&nbsp;<{$subcat.categorylink}> <{/if}> <{if $displaysubcatdsc == 1}>
