...
<{php}>global $xoTheme;$xoTheme->addScript('media/jquery/jquery.js');$xoTheme->addStylesheet(PUBLISHER_URL . '/assets/css/publisher.css');<{/php}>
...
<{php}>global $xoTheme;$xoTheme->addScript('media/jquery/jquery.js');$xoTheme->addStylesheet(PUBLISHER_URL . '/assets/css/publisher.css');$xoTheme->addScript(PUBLISHER_URL . '/assets/js/jquery.easing.js');$xoTheme->addScript(PUBLISHER_URL . '/assets/js/script.easing.js');<{/php}>
