...
<table border="0" width="90%" cellspacing="1" cellpadding="0" align="center" class="outer">
    ...
    <tr>
        <td class="even" align="left">
            ...
            <a href="<{$publisher_url}>/admin/category.php?op=mod&categoryid=<{$category.categoryid}>"><img src="<{$category.image_path}>" title="<{$smarty.const._MD_PUBLISHER_CATEGORY_EDIT}>" alt="<{$lang_editcategory}>"/></a>&nbsp; <{else}>
            ...
            <a href="<{$publisher_url}>/admin/category.php?op=mod&categoryid=<{$category.categoryid}>"><img src="<{$publisher_url}>/assets/images/links/cat.gif" title="<{$lang_editcategory}>" alt="<{$lang_editcategory}>"/></a>&nbsp; <{else}>
            <img src="<{$publisher_url}>/assets/images/links/cat.gif" alt="<{$category.name}>"/>&nbsp; <{/if}>                <!-- End without a selected image path -->                <{/if}>
    ...
    <tr>
        <td class="odd" align="left">
            <div style="padding-left: 10px;">
                ...
                <a href="<{$publisher_url}>/admin/category.php?op=mod&categoryid=<{$subcat.categoryid}>"><img src="<{$subcat.image_path}>" title="<{$lang_editcategory}>" alt="<{$lang_editcategory}>" alt="<{$lang_editcategory}>"/></a>&nbsp;<{$subcat.categorylink}> <{else}>
                <img src="<{$subcat.image_path}>" title="<{$lang_editcategory}>" alt="<{$lang_editcategory}>"/>&nbsp;<{$subcat.categorylink}> <{/if}>                            <!-- End with a selected image path -->                            <{else}>                            <!-- Start without a selected image path -->                                <{if $isAdmin == 1}>
                <a href="<{$publisher_url}>/admin/category.php?op=mod&categoryid=<{$subcat.categoryid}>"><img src="<{$publisher_url}>/assets/images/links/subcat.gif" title="<{$lang_editcategory}>" alt="<{$lang_editcategory}>" alt="<{$lang_editcategory}>"/></a>&nbsp;<{$subcat.categorylink}> <{else}>
                <img src="<{$publisher_url}>/assets/images/links/subcat.gif" title="<{$lang_editcategory}>" alt="<{$lang_editcategory}>"/>&nbsp;<{$subcat.categorylink}> <{/if}> <{if $displaysubcatdsc == 1}>
