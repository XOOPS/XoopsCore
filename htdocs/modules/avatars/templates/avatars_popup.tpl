...
<link rel="stylesheet" href="<{$xoops_url}>/modules/avatars/assets/css/admin.css" type="text/css" />
        ...
        <div class="xo-moduleadmin-infobox outer">
            <div class="xo-window">
                ...
                <div class="xo-window-data">
                        <{foreachq from=$avatars item=avatar name=foo}>
                        <div class="cp-avatar">
                            <div class="xo-thumbimg">
                                <img class="xo-tooltip" src="<{$xoops_url}>/modules/system/class/thumbs/phpThumb.php?src=<{$xoops_rootpath}>/uploads/<{$avatar.avatar_file}>&amp;h=120&amp;w=120" alt="<{$avatar.avatar_name}>" title="<{$avatar.avatar_name}>"/>
                            </div>
