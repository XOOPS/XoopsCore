        ...
        <div class="xo-window-data">
                ...
                <div class="cp-avatar">
                    <div class="xo-thumbimg">
                        <img class="xo-tooltip" src="../../system/class/thumbs/phpThumb.php?src=<{$xoops_rootpath}>/uploads/<{$avatar.avatar_file}>&amp;h=120&amp;w=120" alt="<{$avatar.avatar_name}>" title="<{$avatar.avatar_name}>"/>
                    </div>
