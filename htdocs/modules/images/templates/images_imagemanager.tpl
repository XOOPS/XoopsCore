            ...
            <table cellspacing="0" id="imagemain">
                ...
                <{section name=i loop=$images}>
                    <tr class="txtcenter">
                        ...
                        <td><a href="#" title="" onclick="javascript:appendCode('<{$images[i].lxcode}>');" title=""><img src="<{xoAppUrl assets/images/alignleft.gif}>" alt="Left" /></a> <a href="#" title="" onclick="javascript:appendCode('<{$images[i].xcode}>');" title=""><img src="<{xoAppUrl assets/images/aligncenter.gif}>" alt="Center" /></a> <a href="#" title="" onclick="javascript:appendCode('<{$images[i].rxcode}>');" title=""><img src="<{xoAppUrl assets/images/alignright.gif}>" alt="Right" /></a></td>
                    </tr>
                <{/section}>
            </table>
            <div id="pagenav"><{$pagenav}></div>
