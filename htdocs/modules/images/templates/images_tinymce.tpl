    ...
    <link rel="stylesheet" type="text/css" media="screen" href="assets/css/xoops_images.css" rel="stylesheet" />
    <base target="_self" />
</head>
<body>
    <div class="tabs">
                ...
                <{else}>
                    <{if count($images) > 0}>
                        ...
                        <table cellspacing="0" id="imagemain">
                            ...
                            <{foreachq from=$images item=image name=foo}>
                                <tr class="txtcenter">
                                    ...
                                    <td>
                                        <a href="#" title="" onclick="Xoops_imagesDialog.insert('image<{$smarty.foreach.foo.iteration}>', 'left');" title=""><img src="<{xoAppUrl assets/images/alignleft.gif}>" alt="Left" /></a>
                                        <a href="#" title="" onclick="Xoops_imagesDialog.insert('image<{$smarty.foreach.foo.iteration}>', 'center')" title=""><img src="<{xoAppUrl assets/images/aligncenter.gif}>" alt="Center" /></a>
                                        <a href="#" title="" onclick="Xoops_imagesDialog.insert('image<{$smarty.foreach.foo.iteration}>', 'right');" title=""><img src="<{xoAppUrl assets/images/alignright.gif}>" alt="Right" /></a></td>
                                </tr>
                            <{/foreach}>
                        </table>
                        <div id="pagenav"><{$pagenav}></div>
