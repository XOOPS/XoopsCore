...
class XcaptchaImageForm extends XoopsThemeForm
{
    /**
     * @param null $obj
     */
    public function __construct($object = null)
    {
        ...
        $this->addElement(new XoopsFormRadioYN(_XCAPTCHA_CASESENSITIVE, 'casesensitive', $this->config['casesensitive']));
        ...
        $this->addElement(new XoopsFormTextarea(_XCAPTCHA_SKIP_CHARACTERS, 'skip_characters', $value, 5, 50 ), true);

        $this->addElement(new XoopsFormHidden('type', 'image' ));
