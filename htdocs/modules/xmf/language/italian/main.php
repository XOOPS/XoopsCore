...
// Info
define ('_AM_XMF_CONFIG', 'Controllo configurazione');
define ('_AM_XMF_CONFIG_CHMOD', "La cartella '%s' deve essere con '%s' chmod (&#232; ora impostata su %s)");
define ('_AM_XMF_CONFIG_FOLDERKO', "La cartella '%s' non esiste");
define ('_AM_XMF_CONFIG_FOLDEROK', "'%s' La cartella esiste");
...
define ('_AM_XMF_ABOUT_MODULEINFO', 'Informazioni Modulo');
