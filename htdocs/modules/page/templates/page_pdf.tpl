    ...
    <table style="width: 100%;">
        <tr >
            <td colspan="2" style="text-align: center;">
                <img src="<{xoImgUrl assets/images/logo.png}>" alt="<{$xoops_sitename}>" />
                <br />
                <br />
                <br />
                <br />
        ...
        <{if $content_doauthor || $content_dodate || $content_dohits || $content_doncoms}>
            <tr>
                ...
                <td style="border-top:1px;width:50%;text-align: right;">
                    <{if $content_doncoms}>
                        <em><img src="<{$xoops_url}>/modules/page/assets/images/comments.png" alt="<{$content_comments}>"/>&nbsp;(<{$content_comments}>&nbsp;<{translate key="COMMENTS"}>)</em>
                    <{/if}>
                </td>
            </tr>
        <{/if}>
