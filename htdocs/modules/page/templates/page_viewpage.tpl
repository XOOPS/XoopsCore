    ...
    <div class="page_header">
        ...
        <{if $content_dorating}>
            <div class="page_headerright">
                <{includeq file="module:page|page_rating.tpl"}>
            </div>
        <{/if}>
        <div class="clear"></div>
    </div>
...
<div class="page_content">
    ...
    <br />
    <{$content_text}>
    <{if $related.related_navigation}>
        <div class="clear"></div>
            <{includeq file="module:page|page_navigation.tpl"}>
        <div class="clear"></div>
    <{/if}>
...
<{if $content_doauthor || $content_dodate || $content_dohits || $content_docoms || $content_doncoms}>
    <div class="page_footer">
        ...
        <{if $content_docoms && $content_doncoms}>
            <div class="page_footerright">
                <img src="<{$xoops_url}>/modules/page/assets/images/comments.png" alt="<{$content_comments}>"/>&nbsp;(<{$content_comments}>&nbsp;<{translate key="COMMENTS"}>)
            </div>
        <{/if}>
    </div>
<{/if}>
...
<{if $content_dosocial}>
    <{includeq file='module:xoosocialnetwork|xoosocialnetwork.tpl'}>
<{/if}>
<{if $content_docoms == 1}>
    <{include file='module:comments|comments.tpl'}>
<{/if}>
<{if $content_donotifications}>
