    ...
    <div class="page_header">
        ...
        <{if $block.content_dorating}>
            <div class="page_headerright">
                <{includeq file="module:page|page_rating.tpl" yourvote=$block.yourvote security=$block.security}>
            </div>
        <{/if}>
        <div class="clear"></div>
    </div>
...
<div class="page_content">
    ...
    <{if $block.related.related_navigation}>
        <div class="clear"></div>
            <{includeq file="module:page|page_navigation.tpl" related=$block.related}>
        <div class="clear"></div>
    <{/if}>
    ...
    <div class="page_footer">
        ...
        <{if $block.content_docoms && $block.content_doncoms}>
            <div class="page_footerright">
                <img src="<{$xoops_url}>/modules/page/assets/images/comments.png" alt="<{$block.content_comments}>"/>&nbsp;(<{$block.content_comments}>&nbsp;<{translate key="COMMENTS"}>)
            </div>
        <{/if}>
    </div>
<{/if}>
