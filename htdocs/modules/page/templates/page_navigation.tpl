    ...
    <div class="page_navigation" style="width: 250px;">
        <{if $related.prev_id != 0}>
            <div class="page_navigationL">
                <a href="<{$xoops_url}>/modules/page/viewpage.php?id=<{$related.prev_id}>" title="<{$related.prev_title}>"><img src="<{$xoops_url}>/modules/page/assets/images/previous.png" alt="<{$related.prev_title}>"/></a>
            </div>
        <{/if}>
        <{if $related.next_id != 0}>
            <div class="page_navigationR">
                <a href="<{$xoops_url}>/modules/page/viewpage.php?id=<{$related.next_id}>" title="<{$related.next_title}>"><img src="<{$xoops_url}>/modules/page/assets/images/next.png" alt="<{$related.next_title}>"/></a>
            </div>
        <{/if}>
    </div>
<{/if}>
...
<{if $related.related_navigation == 3}>
    <div class="page_navigation" style="width: 250px;">
        <{if $related.prev_id != 0}>
            <div class="page_navigationL">
                <a href="<{$xoops_url}>/modules/page/viewpage.php?id=<{$related.prev_id}>" title="<{$related.prev_title}>"><img src="<{$xoops_url}>/modules/page/assets/images/previous.png" alt="<{$related.prev_title}>"/>&nbsp;<{$related.prev_title}></a>
            </div>
        <{/if}>
        <{if $related.next_id != 0}>
            <div class="page_navigationR">
                <a href="<{$xoops_url}>/modules/page/viewpage.php?id=<{$related.next_id}>" title="<{$related.next_title}>"><{$related.next_title}>&nbsp;<img src="<{$xoops_url}>/modules/page/assets/images/next.png" alt="<{$related.next_title}>"/></a>
            </div>
        <{/if}>
    </div>
<{/if}>
