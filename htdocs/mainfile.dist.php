...
if (!defined('XOOPS_MAINFILE_INCLUDED')) {
    ...
    if (XOOPS_CHECK_PATH && !@ini_get('safe_mode')) {
        ...
        if (DIRECTORY_SEPARATOR !== '/') {
            ...
            $xoopsScriptPath = str_replace(mb_strpos($xoopsScriptPath, '\\\\', 2) ? '\\\\' : DIRECTORY_SEPARATOR, '/', $xoopsScriptPath);
        }
        if (strcasecmp(mb_substr($xoopsScriptPath, 0, mb_strlen(XOOPS_ROOT_PATH)), str_replace(DIRECTORY_SEPARATOR, '/', XOOPS_ROOT_PATH))) {
